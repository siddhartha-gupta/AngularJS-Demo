System.register(['angular2/core', 'angular2/common', 'angular2/router', '../settings', '../services/generic-config.service'], function(exports_1) {
    ...
    var core_1, common_1, router_1, settings_1, generic_config_service_1;
    var Home;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Home = (function () {
                function Home(genericConfig, router) {
                ...
                Home = __decorate([
                    ...
                    __metadata('design:paramtypes', [generic_config_service_1.GenericConfig, router_1.Router])
                ], Home);
                return Home;
            })();
            exports_1("Home", Home);
